  ...
  const scheduleData = [
    {
      ...
      sessions: 'Sessions: 4th, 11th, 18th, 25th',
    },
    {
      day: 'Tuesdays',
      time: '4:00 PM - 6:00 PM',
      sessions: 'Sessions: 6th, 13th, 20th, 27th',
    },
  ];
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-24 lg:py-32">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black text-white mb-6 tracking-tighter">
              ABACUS
            </h1>
      ...
      <div className="relative py-20 sm:py-28 bg-gradient-to-b from-white/5 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <h2 className="text-4xl sm:text-5xl font-black text-[#0e1f3e] mb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-[#ca3433]/10 to-[#ca3433]/5 rounded-2xl p-8 border border-[#ca3433]/20 hover:border-[#ca3433]/40 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-[#0e1f3e] mb-2">Problem Solving</h3>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="flex items-start gap-6 pb-8 border-b border-white/20">
                  ...
                  <div>
                    <p className="text-4xl font-black text-white mb-1">$350/month</p>
                ...
                <div className="flex items-start gap-6 pb-8 border-b border-white/20">
                  ...
                  <div>
                    <p className="text-2xl font-black text-white mb-1">2 hours per week</p>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <p className="text-2xl font-black text-white mb-4">Class Schedule</p>
      ...
      <div className="relative py-20 sm:py-28 bg-gradient-to-b from-white to-[#f7e0e0]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-black text-[#0e1f3e] mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#ca3433]/10 hover:border-[#ca3433]/30">
              ...
              <h3 className="text-2xl font-bold text-[#0e1f3e] mb-3">Lightning-Fast Calculations</h3>
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#ca3433]/10 hover:border-[#ca3433]/30">
              ...
              <h3 className="text-2xl font-bold text-[#0e1f3e] mb-3">Enhanced Memory & Focus</h3>
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#ca3433]/10 hover:border-[#ca3433]/30">
              ...
              <h3 className="text-2xl font-bold text-[#0e1f3e] mb-3">Academic Excellence</h3>
      ...
      <div className="relative py-20 sm:py-28 bg-gradient-to-br from-[#0e1f3e] via-[#0e1f3e] to-[#1a2f4f] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-[#ca3433] hover:bg-[#a02828] text-white font-black text-lg py-6 px-10 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-lg group"
          >
            Enroll Now
